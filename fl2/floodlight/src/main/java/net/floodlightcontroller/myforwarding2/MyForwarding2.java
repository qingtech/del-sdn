...
package net.floodlightcontroller.myforwarding2;
...
import net.floodlightcontroller.mytopology2.MyFlowList;
...
public class MyForwarding2 extends ForwardingBase implements IFloodlightModule {
	...
	public Command processPacketInMessage(IOFSwitch sw, OFPacketIn pi,
		...
		//System.out.println("!!!!!!!!!!!!!!!!!!!!!!processPacketInMessage");
	...
	@LogMessageDoc(level = "ERROR", message = "Failure writing drop flow mod", explanation = "An I/O error occured while trying to write a "
			+ "drop flow mod to a switch", recommendation = LogMessageDoc.CHECK_SWITCH)
	protected void doDropFlow(IOFSwitch sw, OFPacketIn pi,
			IRoutingDecision decision, FloodlightContext cntx) {
		// initialize match structure and populate it using the packet
		// System.out.println("!!!!!!!!!!!!!!!!!!!!!!doDropFlow");
...
//			System.out.println("sw.port "+port.getPortNumber()+":::::"+port);
//			System.out.println("feacture:::::"+port.getCurrentFeatures());
//			for(OFPortFeatures f: port.getCurrentFeatures()){
...
//		}
		...
		if (dstDevice != null) {
			...
			//System.out.println("srcDevice.Key::::"+srcDevice.getDeviceKey());
